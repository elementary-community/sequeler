...
public class Sequeler.Window : Gtk.ApplicationWindow {
    ...
    public Sequeler.Partials.HeaderBar headerbar;
    ...
    private void build_headerbar () {
        headerbar = new Sequeler.Partials.HeaderBar ();
        toolbar = new Sequeler.Partials.ToolBar ();
        ...
        headerbar.create_new_window.connect (() => {
            app.new_window ();
        });
