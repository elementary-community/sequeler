...
public class Sequeler.Widgets.ConnectionDialog : Gtk.Dialog {
    ...
    public ButtonType connect_button;
    ...
    public ConnectionDialog (Gtk.ApplicationWindow parent, Sequeler.Services.Settings settings, Gee.HashMap? data) { 
        ...
        test_button = new ButtonType (_("Test Connection"), null);
        test_button.sensitive = false;

        var save_button = new ButtonType (_("Save Connection"), null);

        connect_button = new ButtonType (_("Connect"), "suggested-action");
